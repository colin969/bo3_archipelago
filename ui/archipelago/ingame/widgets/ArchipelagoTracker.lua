local APItemList = {
    ...
    [2] ={[1] = "ap_item_quick_revive" ,[2] = "specialty_giant_quickrevive_zombies"},
    [3] ={[1] = "ap_item_juggernog" , [2] ="specialty_giant_juggernaut_zombies"},
    [4] ={[1] = "ap_item_double_tap" ,[2] = "specialty_giant_doubletap_zombies"},
    [5] ={[1] = "ap_item_speed_cola" ,[2] ="specialty_giant_fastreload_zombies"},
    [6] ={[1] = "ap_item_mule_kick" , [2] ="specialty_giant_three_guns_zombies"},
    [7] ={[1] = "ap_item_wunderfizz" , [2] ="archipelago_wunderfizz_perk"},
