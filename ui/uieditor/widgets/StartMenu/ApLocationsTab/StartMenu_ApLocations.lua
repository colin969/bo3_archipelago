...
CoD.StartMenu_ApLocations_Origins = InheritFrom( CoD.StartMenu_ApLocations )
CoD.StartMenu_ApLocations_Origins.new = function( menu, controller )
	self = CoD.StartMenu_ApLocations.new( menu, controller )
	self.itemList:setDataSource( "StartMenu_ApLocations_Origins" )
	return self
end
