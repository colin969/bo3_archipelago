...
function main_start()
{
    level.ap_map_funcs = SpawnStruct();
    level.ap_map_funcs.start_generator = &ap_start_generator;
...
function ap_start_generator() 
{
	self zm_tomb_capture_zones::set_player_controlled_area();
	self.n_current_progress = 100;
	self zm_tomb_capture_zones::generator_state_power_up();
